...
<input type="text" name="data_wystawienia" id="data_wystawienia" placeholder="{{$typ_faktury}}" class="form-control"/>

<label for="mejsce_wystawienia">Miejsce wystawienia</label>
<input type="text" name="mejsce_wystawienia" id="mejsce_wystawienia" placeholder="{{$miejsce_wystawienia}}" class="form-control"/>

<label for="data_sprzedazy">Data sprzedazy</label>
<input type="text" name="data_sprzedazy" id="data_sprzedazy" placeholder="{{$data_sprzedazy}}"class="form-control"/>
...
<button type="submit" class="btn btn-primary">Edytuj Fakture</button>
</form>
</body>
